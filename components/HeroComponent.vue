  ...
  <div class="bg-cream">
    ...
    >
      ...
      >
        ...
        >
          <span class="text-yellow-500">Canteen</span> in online mode is much
          easier now
        </h1>
        <p
          data-aos="fade-down"
        ...
        >
          Foodie Hub is an interesting platform which helps to order your
      ...
      <div id="girl" class="w-full lg:w-6/12 lg:-mt-10 relative">
        ...
        <div
          ...
          data-aos-delay="300"
          data-aos-once="true"
          class="absolute top-32 right-28 sm:left-20 sm:top-56 md:top-20 md:left-80 lg:left-80 lg:top-52 floating-4"
        >
          <img
            class="bg-opacity-80 rounded-lg h-12 sm:h-8 md:h-16"
            src="~/assets/img/burger.webp"
          />
        </div>
        <!-- red -->
        <div
        ...
        >
          <img
            class="bg-opacity-80 rounded-lg h-12 sm:h-12 md:h-20"
            src="~/assets/img/biriyani.webp"
            alt=""
          />
        </div>
        <!-- calendar -->
        <div
          ...
          data-aos-delay="500"
          data-aos-once="true"
          class="absolute top-32 md:bottom-48 lg:bottom-52 -right-6 lg:-right-20 lg:top-52 floating-4"
        >
          <img
            class="bg-opacity-80 rounded-lg h-12 sm:h-16 md:h-20 lg:h-28"
            src="~/assets/img/fork.webp"
          />
        </div>
      </div>
    </div>
