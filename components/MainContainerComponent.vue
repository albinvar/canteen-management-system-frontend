  ...
  >
    ...
    <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
      <h1 class="font-bold text-darken my-3 text-2xl">
        Why to choose <span class="text-yellow-500">Foodie Hub?</span>
      </h1>
      <p class="leading-relaxed text-gray-500">
        Canteen Management Software is an automated software which enables all
        the activities of the canteen and maintain a detailed account of food
        served at the canteen.. It allows secure and speedy transactions. It
        helps management to handle the users by reducing the waiting time for
        the customers.
      </p>
    </div>
    <!-- card -->
    <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
      ...
      >
        ...
        <p class="px-4 text-gray-500">
          A well-structured, organized way of maintaining the canteen’s data
          will ensure no wastage of food or finances, no manipulation of meal
          prices, no proxy mean orders, etc...
        </p>
      </div>
      <div
        data-aos="fade-up"
      ...
      >
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">
          Easy Scheduling & Customizable menu
        </h1>
        <p class="px-4 text-gray-500">
          When a diverse group of people is together for a meal, it becomes very
          important to cater to varying tastes. Features to customize the
          canteen’s menu facilitate this to a great extent.
        </p>
      </div>
      <div
        data-aos="fade-up"
      ...
      >
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 pt-3">
          Food Planning & Customer Reviews
        </h1>
        <p class="px-4 text-gray-500">
          Canteen management systems help an organisation to become adaptive and
          flexible that operates smoothly and efficiently on its own.
        </p>
      </div>
    </div>
    ...
    <div class="mt-28">
      <div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
        <h1 class="text-3xl font-bold mb-4">
          What exactly is <span class="text-yellow-500">Foodie Hub?</span>
        </h1>
    ...
    <div class="sm:flex items-center sm:space-x-8 mt-36">
      <div data-aos="fade-right" class="sm:w-1/2 relative">
        ...
        <h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">
          Everything you can do in a physical canteen,
          <span class="text-yellow-500">you can do with Foodie Hub</span>
        </h1>
        <p class="py-5 lg:pr-32">
          Foodie Hub helps traditional and online food ordering and to manage
          scheduling, payments all in one secure cloud-based system.
        </p>
    ...
    <div class="md:flex mt-40 md:space-x-10 items-start">
      ...
      <div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
        ...
        <div class="flex items-center space-x-5 my-5">
          ...
          <p>
            Foodie Hub tracks orders and can recommend you better
            recommendations.
          </p>
        </div>
        <div class="flex items-center space-x-5 my-5">
    ...
    <div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
      <div data-aos="fade-right" class="md:w-1/2 lg:pl-14">
        <h1 class="text-darken font-semibold text-3xl lg:pr-56">
          <span class="text-yellow-500">FOOD Online,</span> is it safe?
        </h1>
        <p class="text-gray-500 my-4 lg:pr-32">
          Foodie Hub has a dynamic set of safety tools built to be deployed and
          used for safe transactions.
        </p>
      </div>
      <img
        data-aos="fade-left"
        class="md:w-1/2"
        src="~/assets/img/girl-with-books.webp"
      />
    </div>
    ...
    >
      <div data-aos="fade-right" class="md:w-6/12">
        <img
          class="md:w-11/12 rounded-xl"
          src="~/assets/img/hotel-interior.webp"
        />
      </div>
      <div
        data-aos="fade-left"
      ...
      >
        <h1 class="font-semibold text-darken text-3xl lg:pr-64">
          Online, <span class="text-yellow-500">Safe </span>& Instant Food
        </h1>
        <p class="text-gray-500 my-5 lg:pr-52">
          Why stand in que when you could order your food online. Order your
          food, grab on your seats and enjoy the meal
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row items-center mt-12">
      <div data-aos="fade-right" class="md:w-5/12">
        ...
        <p class="my-5 lg:pr-14">
          When a diverse group of people is together for a meal, it becomes very
          important to cater to varying tastes. Features to customize thee
          canteen's menu facilitate this to a great extent
        </p>
      </div>
      <img
        data-aos="fade-left"
        class="md:w-7/12"
        src="~/assets/img/girl_introducing.webp"
      />
    </div>
    ...
    >
      ...
      >
        <h1 class="font-semibold text-darken text-3xl lg:pr-64">
          FOOD <span class="text-yellow-500"> That we love!</span>
        </h1>
        <p class="text-gray-500 my-5 lg:pr-24">
          Food may be essential as fuel for the body. But good fuel for the
          soul.
        </p>
      </div>
    </div>
    ...
    <div class="sm:flex items-center sm:space-x-8 mt-36">
      <div data-aos="fade-right" class="sm:w-1/2 relative">
        ...
        ></div>
        <h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">
          With our wide range of recipes,
          <span class="text-yellow-500">you can do it with Foodie Hub</span>
        </h1>
        <p class="py-5 lg:pr-32">
    ...
    >
      ...
      >
        <h1 class="font-semibold text-darken text-3xl lg:pr-64">
          Grab your meals and
          <span class="text-yellow-500"> enjoy your food</span>
        </h1>
        <p class="text-gray-500 my-5 lg:pr-24">
