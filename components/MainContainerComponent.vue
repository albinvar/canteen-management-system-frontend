<template>
  <div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
    ...
    <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
      <h1 class="font-bold text-darken my-3 text-2xl">Why to choose <span class="text-yellow-500">Foodie Hub?</span></h1>
      <p class="leading-relaxed text-gray-500">Canteen Management Software is an automated software which enables all the activities of the canteen and maintain a detailed account of food served at the canteen.. It allows secure and speedy transactions. It helps management to handle the users by reducing the waiting time for the customers.
      </p>
    </div>
    <!-- card -->
    <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
      <div data-aos="fade-up" class="bg-white shadow-xl p-6 text-center rounded-xl">
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Online Billing & Invoicing</h1>
        <p class="px-4 text-gray-500">A well-structured, organized way of maintaining the canteen’s data will ensure no wastage of food or finances, no manipulation of meal prices, no proxy mean orders, etc...</p>
      </div>
      <div data-aos="fade-up" data-aos-delay="150" class="bg-white shadow-xl p-6 text-center rounded-xl">
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Easy Scheduling & Customizable menu</h1>
        <p class="px-4 text-gray-500">When a diverse group of people is together for a meal, it becomes very important to cater to varying tastes. Features to customize the canteen’s menu facilitate this to a great extent.</p>
      </div>
      <div data-aos="fade-up" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 pt-3">Food Planning & Customer Reviews</h1>
        <p class="px-4 text-gray-500">Canteen management systems help an organisation to become adaptive and flexible  that operates smoothly and efficiently on its own.</p>
      </div>
    </div>
    ...
    <div class="mt-28">
      <div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
        <h1 class="text-3xl font-bold mb-4">What exactly is <span class="text-yellow-500">Foodie Hub?</span></h1>
        <p class="text-gray-500">Canteen Management Software is an automated software which enables all the activities of the canteen and maintain a detailed account of food served at the canteen.. It allows secure and speedy transactions. It helps management to handle the users by reducing the waiting time for the customers.</p>
      </div>
      <div data-aos="fade-up" class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
        <div class="relative md:w-5/12">
          <img class="rounded-2xl" src="~/assets/img/employees.webp" alt="">
        ...
        <div class="relative md:w-5/12">
          <img class="rounded-2xl" src="~/assets/img/students.webp" alt="">
          <div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
    ...
    <div class="sm:flex items-center sm:space-x-8 mt-36">
      ...
      <div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
        ...
        <img class="rounded-xl z-40 relative" src="~/assets/img/couple.webp" alt="">
    ...
    <div class="md:flex mt-40 md:space-x-10 items-start">
      <div data-aos="fade-down" class="md:w-7/12 relative">
        ...
        <img class="relative z-50 floating" src="~/assets/img/vcall.webp" alt="">
    ...
    <div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
      ...
      <img data-aos="fade-left" class="md:w-1/2" src="~/assets/img/girl-with-books.webp">
    </div>
    <!-- Assessments, Quizzes, Tests -->

    <div class="mt-20 flex flex-col-reverse md:flex-row items-center md:space-x-10">
      <div data-aos="fade-right" class="md:w-6/12">
        <img class="md:w-11/12 rounded-xl" src="~/assets/img/hotel-interior.webp">
      </div>
    ...
    <div class="flex flex-col md:flex-row items-center mt-12">
      ...
      <img data-aos="fade-left" class="md:w-7/12" src="~/assets/img/girl_introducing.webp">
    </div>

    <!-- One-on-One Discussions -->
    <div class="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
      <div data-aos="fade-right" class="md:w-7/12">
        <img class="md:w-11/12" src="~/assets/img/girl-with-coffee.webp">
      </div>
    ...
    <div class="sm:flex items-center sm:space-x-8 mt-36">
      ...
      <div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
        <div style="background: #23BDEE;" class="floating w-24 h-24 absolute rounded-lg z-0 -top-3 -left-3"></div>
        <img class="rounded-xl z-40 relative" src="~/assets/img/chef.webp" alt="">
        <button class="bg-white w-14 h-14 rounded-full flex items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out z-50">
          <svg class="w-5 h-5 ml-1" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.5751 12.8097C23.2212 13.1983 23.2212 14.135 22.5751 14.5236L1.51538 27.1891C0.848878 27.5899 5.91205e-07 27.1099 6.25202e-07 26.3321L1.73245e-06 1.00123C1.76645e-06 0.223477 0.848877 -0.256572 1.51538 0.14427L22.5751 12.8097Z" fill="#23BDEE"/>
          </svg>
    ...
    <div class="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
      <div data-aos="fade-right" class="md:w-7/12">
        <img class="md:w-11/12" src="~/assets/img/double-ok.webp">
      </div>
      <div data-aos="fade-left" class="md:w-5/12 md:transform md:-translate-y-6">
...
<script>
export default {
  name: 'MainContainerComponent.vue'
}
</script>
