  ...
  <footer class="mt-32" style="background-color: rgba(37, 38, 65, 1);">
    <div class="max-w-lg mx-auto">
      <div class="flex py-12 justify-center text-white items-center px-20 sm:px-36">
        <div class="relative">
          <h1 class="font-bold text-xl pr-5 relative z-50">Foodie Hub</h1>
        ...
        <span class="border-l border-gray-500 text-sm pl-5 py-2 font-semibold">Canteen Management System</span>
      </div>
      ...
      <div class="text-center text-white">
        <p class="my-3 text-gray-400 text-sm">&copy; 2022  Foodie Hub Technology Inc. </p>

        <!--credits to https://github.com/mhaecal -->
        <!--model: https://www.freepik.com/master1305 -->
